...
and pull requests; the published documentation is bilingual, French by default, and **a page never
ships without its twin**.

Same in `contributing.md`, and the entry under `[Unreleased]` in `CHANGELOG.md`.
