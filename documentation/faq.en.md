...
This is softened by the [last line of defense](api.en.md#last-line-of-defense): a dark site keeps a
...
debug information](api.en.md#setting-debug-information)) to get detailed information on every SAM
site and EW radar.
...
See [connecting Skynet to the MOOSE AI_A2A_DISPATCHER](api.en.md#connecting-skynet-to-the-moose-ai_a2a_dispatcher).
