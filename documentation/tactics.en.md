...
See [which SAM systems can engage HARMs?](faq.en.md#which-sam-systems-can-engage-harms) and the
[point defence setup example](api.en.md#point-defence).
...
See [adding a jammer](api.en.md#adding-a-jammer) for the setup.
