...
Load the compiled skynet code into a mission. Skynet itself no longer requires MIST — the [skynet-iads-compiled.lua](/demo-missions/skynet-iads-compiled.lua) is a drop-in script. However, the demo missions bundle [mist_4_5_107.lua](/demo-missions/mist_4_5_107.lua) for other functionality, and you can download the current MIST version [here](https://github.com/mrSkortch/MissionScriptingTools) if needed. Both files are located in the [/demo-missions/](/demo-missions) folder. 
